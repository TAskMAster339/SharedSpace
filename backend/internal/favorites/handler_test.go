...
type mockService struct {
	...
	listFn   func(string) (FavoritesListResponse, error)
}
...
func (m *mockService) List(_ context.Context, userID string) (FavoritesListResponse, error) {
	if m.listFn != nil {
...
func TestHandlerList(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		svc := &mockService{
			listFn: func(userID string) (FavoritesListResponse, error) {
	...
	t.Run("empty result", func(t *testing.T) {
		svc := &mockService{
			listFn: func(_ string) (FavoritesListResponse, error) {
