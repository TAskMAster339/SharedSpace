    ...
    <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-6 sticky top-0 z-10 w-full shrink-0">
      ...
      <Link to="/dashboard" className="flex items-center gap-2 cursor-pointer group">
        ...
        <span className="text-xl font-semibold tracking-tight">
          <span className="text-[#1e3a8a]">Shared</span><span className="text-[#60a5fa]">Space</span>
        </span>
      </Link>
      ...
      {isAuthenticated ? (
        <>
          ...
          <div className="flex items-center gap-4">
            {/* Колокольчик */}
            <Link to="/invitations" className="relative p-2 rounded-full hover:bg-gray-100 transition-colors">
            ...
            <div className="relative">
              ...
              >
                <img src={avatar} alt="User" className="w-8 h-8 rounded-full border border-gray-200" />
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/register" className="text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg transition-colors">Sign Up</Link>
        </div>
      )}
    </header>
  );
